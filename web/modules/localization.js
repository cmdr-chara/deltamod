(() => {
    ...
    const communityStrings = Object.freeze({
        en: {
            ui_profiles_health: "Profiles & health",
            ui_file_safety: "File safety",

            ui_nav_play: "Play & patch",
            ui_nav_library: "Mod library",
            ui_nav_games: "Installations",
            ui_nav_shop: "Mod Shop",
            ui_nav_collections: "Collections",
            ui_nav_about: "About",
            ui_search_mods: "Search mods",
            ui_search_hint: "Name, author, version or package ID",
            ui_result_count: "{0} of {1} shown",
            ui_no_matches: "No matching mods",
            ui_clear: "Clear search",
            ui_retry: "Try again",
            ui_load_failed: "This view could not be loaded",
            ui_try_again: "Please try again.",
            ui_skip: "Skip to content",
            ui_patch_launch: "Apply & launch",
            ui_details: "View in library",
            ui_progress: "Progress",
            ui_log: "Activity log",
            ui_collection_desc: "Save and manage your GameBanana mod collections.",
            ui_collection_name: "New collection name",
            ui_create_collection: "Create collection",
            ui_empty_collections: "No collections yet",
            ui_back: "Back",
            ui_patching: "Patching the game…",
            ui_patch_complete: "Patching complete",
            ui_patch_ready: "Your selected mods have been applied.",
            ui_return_mods: "Return to mods",
        ...
        it: {
            ui_profiles_health: "Profili e integrità",
            ui_file_safety: "Sicurezza dei file",

            ui_nav_play: "Gioca e applica",
            ui_nav_library: "Libreria mod",
            ui_nav_games: "Installazioni",
            ui_nav_shop: "Negozio mod",
            ui_nav_collections: "Collezioni",
            ui_nav_about: "Informazioni",
            ui_search_mods: "Cerca mod",
            ui_search_hint: "Nome, autore, versione o ID pacchetto",
            ui_result_count: "{0} di {1} visibili",
            ui_no_matches: "Nessuna mod corrispondente",
            ui_clear: "Cancella ricerca",
            ui_retry: "Riprova",
            ui_load_failed: "Impossibile caricare questa schermata",
            ui_try_again: "Riprova.",
            ui_skip: "Vai al contenuto",
            ui_patch_launch: "Applica e avvia",
            ui_details: "Apri nella libreria",
            ui_progress: "Avanzamento",
            ui_log: "Registro attività",
            ui_collection_desc: "Salva e gestisci le tue collezioni di mod GameBanana.",
            ui_collection_name: "Nome della nuova collezione",
            ui_create_collection: "Crea collezione",
            ui_empty_collections: "Nessuna collezione",
            ui_back: "Indietro",
            ui_patching: "Applicazione delle mod…",
            ui_patch_complete: "Mod applicate",
            ui_patch_ready: "Le mod selezionate sono state applicate.",
            ui_return_mods: "Torna alle mod",
        ...
        pl: {
            ui_profiles_health: "Profile i stan",
            ui_file_safety: "Bezpieczeństwo plików",

            ui_nav_play: "Graj i modyfikuj",
            ui_nav_library: "Biblioteka modów",
            ui_nav_games: "Instalacje",
            ui_nav_shop: "Sklep z modami",
            ui_nav_collections: "Kolekcje",
            ui_nav_about: "Informacje",
            ui_search_mods: "Szukaj modów",
            ui_search_hint: "Nazwa, autor, wersja lub ID pakietu",
            ui_result_count: "Widoczne: {0} z {1}",
            ui_no_matches: "Brak pasujących modów",
            ui_clear: "Wyczyść wyszukiwanie",
            ui_retry: "Spróbuj ponownie",
            ui_load_failed: "Nie można załadować widoku",
            ui_try_again: "Spróbuj ponownie.",
            ui_skip: "Przejdź do treści",
            ui_patch_launch: "Zastosuj i uruchom",
            ui_details: "Otwórz w bibliotece",
            ui_progress: "Postęp",
            ui_log: "Dziennik aktywności",
            ui_collection_desc: "Zapisuj kolekcje modów GameBanana i zarządzaj nimi.",
            ui_collection_name: "Nazwa nowej kolekcji",
            ui_create_collection: "Utwórz kolekcję",
            ui_empty_collections: "Brak kolekcji",
            ui_back: "Wstecz",
            ui_patching: "Modyfikowanie gry…",
            ui_patch_complete: "Modyfikowanie zakończone",
            ui_patch_ready: "Wybrane mody zostały zastosowane.",
            ui_return_mods: "Wróć do modów",
        ...
        es: {
            ui_profiles_health: "Perfiles e integridad",
            ui_file_safety: "Seguridad de archivos",

            ui_nav_play: "Jugar y modificar",
            ui_nav_library: "Biblioteca de mods",
            ui_nav_games: "Instalaciones",
            ui_nav_shop: "Tienda de mods",
            ui_nav_collections: "Colecciones",
            ui_nav_about: "Información",
            ui_search_mods: "Buscar mods",
            ui_search_hint: "Nombre, autor, versión o ID del paquete",
            ui_result_count: "{0} de {1} visibles",
            ui_no_matches: "No hay mods coincidentes",
            ui_clear: "Borrar búsqueda",
            ui_retry: "Reintentar",
            ui_load_failed: "No se pudo cargar esta vista",
            ui_try_again: "Inténtalo de nuevo.",
            ui_skip: "Ir al contenido",
            ui_patch_launch: "Aplicar e iniciar",
            ui_details: "Ver en la biblioteca",
            ui_progress: "Progreso",
            ui_log: "Registro de actividad",
            ui_collection_desc: "Guarda y gestiona tus colecciones de mods de GameBanana.",
            ui_collection_name: "Nombre de la nueva colección",
            ui_create_collection: "Crear colección",
            ui_empty_collections: "Aún no hay colecciones",
            ui_back: "Volver",
            ui_patching: "Aplicando mods al juego…",
            ui_patch_complete: "Mods aplicados",
            ui_patch_ready: "Se han aplicado los mods seleccionados.",
            ui_return_mods: "Volver a los mods",
        ...
        fr: {
            ui_profiles_health: "Profils et intégrité",
            ui_file_safety: "Sécurité des fichiers",

            ui_nav_play: "Jouer et modifier",
            ui_nav_library: "Bibliothèque de mods",
            ui_nav_games: "Installations",
            ui_nav_shop: "Boutique de mods",
            ui_nav_collections: "Collections",
            ui_nav_about: "À propos",
            ui_search_mods: "Rechercher des mods",
            ui_search_hint: "Nom, auteur, version ou identifiant du paquet",
            ui_result_count: "{0} sur {1} affichés",
            ui_no_matches: "Aucun mod correspondant",
            ui_clear: "Effacer la recherche",
            ui_retry: "Réessayer",
            ui_load_failed: "Impossible de charger cette vue",
            ui_try_again: "Veuillez réessayer.",
            ui_skip: "Aller au contenu",
            ui_patch_launch: "Appliquer et lancer",
            ui_details: "Voir dans la bibliothèque",
            ui_progress: "Progression",
            ui_log: "Journal d’activité",
            ui_collection_desc: "Enregistrez et gérez vos collections de mods GameBanana.",
            ui_collection_name: "Nom de la nouvelle collection",
            ui_create_collection: "Créer une collection",
            ui_empty_collections: "Aucune collection",
            ui_back: "Retour",
            ui_patching: "Application des mods…",
            ui_patch_complete: "Mods appliqués",
            ui_patch_ready: "Les mods sélectionnés ont été appliqués.",
            ui_return_mods: "Retour aux mods",
        ...
        de: {
            ui_profiles_health: "Profile und Zustand",
            ui_file_safety: "Dateisicherheit",

            ui_nav_play: "Spielen und patchen",
            ui_nav_library: "Mod-Bibliothek",
            ui_nav_games: "Installationen",
            ui_nav_shop: "Mod-Shop",
            ui_nav_collections: "Sammlungen",
            ui_nav_about: "Info",
            ui_search_mods: "Mods suchen",
            ui_search_hint: "Name, Autor, Version oder Paket-ID",
            ui_result_count: "{0} von {1} angezeigt",
            ui_no_matches: "Keine passenden Mods",
            ui_clear: "Suche löschen",
            ui_retry: "Erneut versuchen",
            ui_load_failed: "Diese Ansicht konnte nicht geladen werden",
            ui_try_again: "Bitte erneut versuchen.",
            ui_skip: "Zum Inhalt",
            ui_patch_launch: "Anwenden und starten",
            ui_details: "In Bibliothek öffnen",
            ui_progress: "Fortschritt",
            ui_log: "Aktivitätsprotokoll",
            ui_collection_desc: "GameBanana-Mod-Sammlungen speichern und verwalten.",
            ui_collection_name: "Name der neuen Sammlung",
            ui_create_collection: "Sammlung erstellen",
            ui_empty_collections: "Noch keine Sammlungen",
            ui_back: "Zurück",
            ui_patching: "Spiel wird gepatcht…",
            ui_patch_complete: "Patch abgeschlossen",
            ui_patch_ready: "Die ausgewählten Mods wurden angewendet.",
            ui_return_mods: "Zurück zu den Mods",
        ...
        'pt-br': {
            ui_profiles_health: "Perfis e integridade",
            ui_file_safety: "Segurança dos arquivos",

            ui_nav_play: "Jogar e modificar",
            ui_nav_library: "Biblioteca de mods",
            ui_nav_games: "Instalações",
            ui_nav_shop: "Loja de mods",
            ui_nav_collections: "Coleções",
            ui_nav_about: "Sobre",
            ui_search_mods: "Buscar mods",
            ui_search_hint: "Nome, autor, versão ou ID do pacote",
            ui_result_count: "{0} de {1} exibidos",
            ui_no_matches: "Nenhum mod correspondente",
            ui_clear: "Limpar busca",
            ui_retry: "Tentar novamente",
            ui_load_failed: "Não foi possível carregar esta tela",
            ui_try_again: "Tente novamente.",
            ui_skip: "Ir para o conteúdo",
            ui_patch_launch: "Aplicar e iniciar",
            ui_details: "Ver na biblioteca",
            ui_progress: "Progresso",
            ui_log: "Registro de atividades",
            ui_collection_desc: "Salve e gerencie suas coleções de mods do GameBanana.",
            ui_collection_name: "Nome da nova coleção",
            ui_create_collection: "Criar coleção",
            ui_empty_collections: "Nenhuma coleção ainda",
            ui_back: "Voltar",
            ui_patching: "Aplicando mods ao jogo…",
            ui_patch_complete: "Mods aplicados",
            ui_patch_ready: "Os mods selecionados foram aplicados.",
            ui_return_mods: "Voltar aos mods",
        ...
        ja: {
            ui_profiles_health: "プロファイルと整合性",
            ui_file_safety: "ファイルの安全性",

            ui_nav_play: "プレイ・パッチ",
            ui_nav_library: "Modライブラリ",
            ui_nav_games: "インストール",
            ui_nav_shop: "Modショップ",
            ui_nav_collections: "コレクション",
            ui_nav_about: "アプリ情報",
            ui_search_mods: "Modを検索",
            ui_search_hint: "名前・作者・バージョン・パッケージID",
            ui_result_count: "{1}件中{0}件を表示",
            ui_no_matches: "該当するModがありません",
            ui_clear: "検索をクリア",
            ui_retry: "再試行",
            ui_load_failed: "画面を読み込めませんでした",
            ui_try_again: "もう一度お試しください。",
            ui_skip: "コンテンツへ移動",
            ui_patch_launch: "適用して起動",
            ui_details: "ライブラリで表示",
            ui_progress: "進行状況",
            ui_log: "アクティビティログ",
            ui_collection_desc: "GameBananaのModコレクションを保存・管理します。",
            ui_collection_name: "新しいコレクション名",
            ui_create_collection: "コレクションを作成",
            ui_empty_collections: "コレクションはありません",
            ui_back: "戻る",
            ui_patching: "パッチを適用中…",
            ui_patch_complete: "パッチの適用が完了",
            ui_patch_ready: "選択したMODを適用しました。",
            ui_return_mods: "Modに戻る",
