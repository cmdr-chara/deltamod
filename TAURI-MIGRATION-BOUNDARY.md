...
The current Electron package remains the reference implementation and rollback artifact until `RELEASE-GATE.md` passes. Do not remove Electron scripts, assets, or release jobs as part of the first stable Tauri release.
